...
class StaffDetailWidget extends StatefulWidget {
  ...
  @override
  _StaffDetailWidgetState createState() => _StaffDetailWidgetState();
}
      ...
      child: Scaffold(
          ...
          child: AppBar(
            ...
            title: FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                final textStaffDetailResponse = snapshot.data!;
                return Text(
                  StaffDetailCall.ftname(
                    textStaffDetailResponse.jsonBody,
                  ).toString(),
        ...
        body: FutureBuilder<ApiCallResponse>(
          ...
          builder: (context, snapshot) {
            ...
            final columnStaffDetailResponse = snapshot.data!;
            return Column(
                  ...
                  child: Stack(
                    children: [
                      Align(
                        ...
                        child: Text(
                          StaffDetailCall.position(
                            columnStaffDetailResponse.jsonBody,
                          ).toString(),
